---
title: View Individual Postings
article_id: 15295156691732
section: 01-views-and-reports
index: 91
url: https://storis.zendesk.com/hc/en-us/articles/15295156691732-View-Individual-Postings
source: STORIS Help Center (storis.zendesk.com)
---

Access

Accounting > General Ledger > View Individual Postings

Tabs: Header, Detail Postings

NOTE: This is a read-only screen. You cannot edit any data on this screen. To view postings, you must have inquiry permissions to view the account(s) established in General Ledger User Permissions. The documentation below describes the entry version of this routine. You can use it here for reference purposes.
