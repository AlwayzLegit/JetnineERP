...
CREATE UNIQUE INDEX "integrations_business_provider_uniq" ON "integrations" USING btree ("business_id","provider");--> statement-breakpoint
CREATE INDEX "integrations_business_id_idx" ON "integrations" USING btree ("business_id");